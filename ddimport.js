    ...
    button.click(function() {
      new Dialog({
        ...
        `</div>
         ...
         <div class="form-group import"><div class="import-options" title = "Offset to the wall in the file, in 1/10 grid units">Offset</div><input type="range" min="-10" max="+10" value: "0" name="offset"></div>
        ...
        buttons :{
          import : {
            ...
            callback : async (html) => {
              ...
              let offset = html.find('[name="offset"]').val()/10
